    ...
    return (
      <div className="text-sm text-destructive">
        {heartbeatsQuery.error instanceof Error
          ...
          : t("instanceSettings.loadHeartbeatsFailed")}
      </div>
    );
  }
    ...
    <div className="max-w-5xl space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          {t("instanceSettings.schedulerHeartbeatsDesc")}
        </p>
      </div>
        ...
        {anyEnabled && (
          <Button
            ...
            onClick={() => {
              ...
              if (!window.confirm(t("instanceSettings.disableAllConfirm", { count: enabledCount, noun }))) {
                return;
              }
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="ml-auto flex items-center gap-1.5 shrink-0">
                          ...
                          >
                            {saving ? "..." : agent.heartbeatEnabled ? t("instanceSettings.disableHeartbeat") : t("instanceSettings.enableHeartbeat")}
                          </Button>
                        </span>
                      </div>
                    );
